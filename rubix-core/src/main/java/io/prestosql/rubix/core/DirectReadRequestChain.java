...
public class DirectReadRequestChain extends ReadRequestChain
{
  ...
  public ReadRequestChainStats getStats()
  {
    return new ReadRequestChainStats()
            .setDirectRRCDataRead(totalRead)
            .setDirectRRCRequests(requests);
  }

  @Override
  public Long call() throws IOException
  {
    log.debug(format("Read Request threadName: %s, Direct read Executor threadName: %s", threadName, Thread.currentThread().getName()));
