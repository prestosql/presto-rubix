...
public class TestRemoteReadRequestChain
{
      ...
      throws IOException
  {
    ...
    localFileName = CacheUtil.getLocalPath(backendFileName, conf, CacheUtil.UNKONWN_GENERATION_NUMBER + 1);
    File file = new File(localFileName);
    file.createNewFile();
    file.setWritable(true, false);
    file.setReadable(true, false);

    remoteReadRequestChain = new RemoteReadRequestChain(fsDataInputStream, backendFileName, CacheUtil.UNKONWN_GENERATION_NUMBER + 1, conf);
  }
