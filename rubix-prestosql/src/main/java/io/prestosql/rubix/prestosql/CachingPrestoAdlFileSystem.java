...
public class CachingPrestoAdlFileSystem extends CachingFileSystem<AdlFileSystem>
{
  private static final String SCHEME = "adl";

  public CachingPrestoAdlFileSystem()
  {
    super();
  }
