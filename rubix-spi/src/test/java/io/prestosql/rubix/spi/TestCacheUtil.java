...
public class TestCacheUtil
{
  ...
  public void testGetLocalPath()
  {
    ...
    String localPath = CacheUtil.getLocalPath(remotePath, conf, CacheUtil.UNKONWN_GENERATION_NUMBER + 1);
  ...
  public void testGetLocalPath_noRemotePathScheme()
  {
    ...
    String localPath = CacheUtil.getLocalPath(localRelPath, conf, CacheUtil.UNKONWN_GENERATION_NUMBER + 1);
    assertEquals(localPath, getExpectedPath(cacheTestDirPrefix, localRelPath, false), "Paths not equal!");
  }
  ...
  public void testGetMetadataFilePathForS3() throws IOException
  {
    ...
    String localPath = CacheUtil.getMetadataFilePath(remotePath, conf, CacheUtil.UNKONWN_GENERATION_NUMBER + 1);
    ...
    localPath = CacheUtil.getMetadataFilePath(remotePath, conf, CacheUtil.UNKONWN_GENERATION_NUMBER + 1);
    assertEquals(localPath, getExpectedPath(cacheTestDirPrefix, localRelPath, true), "Paths not equal!");
  }
  ...
  String getExpectedPath(String cacheTestDirPrefix, String localRelPath, boolean mdFile)
  {
    ...
    return String.format("%s0/fcache/%s%s_g%d", cacheTestDirPrefix, localRelPath, metadataPrefix, CacheUtil.UNKONWN_GENERATION_NUMBER + 1);
  }
