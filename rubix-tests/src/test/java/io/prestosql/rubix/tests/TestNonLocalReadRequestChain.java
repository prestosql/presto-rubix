...
package io.prestosql.rubix.tests;
...
import io.prestosql.rubix.bookkeeper.BookKeeperServer;
import io.prestosql.rubix.bookkeeper.LocalDataTransferServer;
import io.prestosql.rubix.common.utils.DataGen;
import io.prestosql.rubix.common.utils.DeleteFileVisitor;
import io.prestosql.rubix.core.MockCachingFileSystem;
import io.prestosql.rubix.core.NonLocalReadRequestChain;
...
import io.prestosql.rubix.spi.DataTransferClientFactory;
...
public class TestNonLocalReadRequestChain
{
      ...
      throws IOException
  {
    ...
    File mdFile = new File(CacheUtil.getMetadataFilePath(backendPath.toString(), conf, CacheUtil.UNKONWN_GENERATION_NUMBER + 1));
    mdFile.delete();

    File localFile = new File(CacheUtil.getLocalPath(backendPath.toString(), conf, CacheUtil.UNKONWN_GENERATION_NUMBER + 1));
    localFile.delete();
    backendFile.delete();
